                ...
                <Row className="justify-content-center">
                    <Card style={{
                                ...
                                <Row>
                                    <Col md={6} className="mb-4">
                                        <Form.Group controlId="contactName">
                                            <Form.Label className="text-dark" style={{ fontWeight: 500 }}>Name</Form.Label>
                                            <Form.Control
                                                className="text-dark"
                                                style={{
                                                    border: "none",
                                    ...
                                    <Col md={6} className="mb-4">
                                        <Form.Group controlId="contactEmail">
                                            <Form.Label className="text-dark" style={{ fontWeight: 500 }}>Email</Form.Label>
                                            <Form.Control
                                                className="text-dark"
                                                style={{
                                                    border: "none",
                                ...
                                <Row>
                                    <Col md={6} className="mb-4">
                                        <Form.Group controlId="contactPhone">
                                            <Form.Label className="text-dark" style={{ fontWeight: 500 }}>Phone</Form.Label>
                                            <Form.Control
                                                className="text-dark"
                                                style={{
                                                    border: "none",
                        ...
                        <Col md={4} className="bg-primary text-body" style={{
                            ...
                            <div>
                                <h5 style={{ fontWeight: 600, marginBottom: 12, textAlign: "center" }}>Contact Information</h5>
